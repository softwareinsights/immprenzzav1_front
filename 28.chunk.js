...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ciudads_routing__ = __webpack_require__(1378);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ciudads_component__ = __webpack_require__(1300);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_ciudads_table_ciudads_service__ = __webpack_require__(80);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_ciudads_table_ciudads_table_component__ = __webpack_require__(1301);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ciudads_service__ = __webpack_require__(80);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ciudads_add_modal_ciudads_add_modal_component__ = __webpack_require__(200);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ciudads_edit_modal_ciudads_edit_modal_component__ = __webpack_require__(558);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__personas_components_personas_table_personas_add_modal_personas_add_modal_component__ = __webpack_require__(78);
...
var CiudadsTableComponent = (function () {
    function CiudadsTableComponent(service, toastrService, dialogService, route, router) {
    ...
    CiudadsTableComponent.prototype.insertPersona = function (ciudads) {
        ...
        var disposable = this.dialogService.addDialog(__WEBPACK_IMPORTED_MODULE_7__personas_components_personas_table_personas_add_modal_personas_add_modal_component__["a" /* PersonasAddModalComponent */], persona)
    ...
    CiudadsTableComponent.prototype.addModalShow = function () {
        var _this = this;
        var disposable = this.dialogService.addDialog(__WEBPACK_IMPORTED_MODULE_5__ciudads_add_modal_ciudads_add_modal_component__["a" /* CiudadsAddModalComponent */])
            .subscribe(function (data) {
            if (data) {
    ...
    CiudadsTableComponent.prototype.editModalShow = function (ciudads) {
        var _this = this;
        var disposable = this.dialogService.addDialog(__WEBPACK_IMPORTED_MODULE_6__ciudads_edit_modal_ciudads_edit_modal_component__["a" /* CiudadsEditModalComponent */], ciudads)
            .subscribe(function (data) {
            if (data) {
                _this.showToast(data);
            }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_router__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ciudads_component__ = __webpack_require__(1300);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_ciudads_table_ciudads_table_component__ = __webpack_require__(1301);
