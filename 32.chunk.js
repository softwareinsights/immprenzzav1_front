...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__archivos_routing__ = __webpack_require__(1373);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__archivos_component__ = __webpack_require__(1290);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_archivos_table_archivos_service__ = __webpack_require__(187);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_archivos_table_archivos_table_component__ = __webpack_require__(1291);
...
var ArchivosModule = (function () {
    function ArchivosModule() {
    }
    return ArchivosModule;
}());
ArchivosModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_8__archivos_routing__["a" /* routing */],
        ...
        declarations: [
            __WEBPACK_IMPORTED_MODULE_9__archivos_component__["a" /* ArchivosComponent */],
            __WEBPACK_IMPORTED_MODULE_11__components_archivos_table_archivos_table_component__["a" /* ArchivosTableComponent */],
        ],
        entryComponents: [],
        providers: [
            __WEBPACK_IMPORTED_MODULE_10__components_archivos_table_archivos_service__["a" /* ArchivosService */]
        ]
    })
], ArchivosModule);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ArchivosComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ArchivosComponent = (function () {
...
//# sourceMappingURL=archivos.component.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__archivos_service__ = __webpack_require__(187);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__archivos_add_modal_archivos_add_modal_component__ = __webpack_require__(545);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__archivos_edit_modal_archivos_edit_modal_component__ = __webpack_require__(554);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ArchivosTableComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ArchivosTableComponent = (function () {
    function ArchivosTableComponent(service, toastrService, dialogService, route, router) {
        ...
        this.filterQuery = '';
        this.rowsOnPage = 10;
        this.sortBy = 'idarchivo';
        this.sortOrder = 'asc';
    }
    ArchivosTableComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    ArchivosTableComponent.prototype.findByIdOrdentarea = function (id) {
        var _this = this;
        this.service
    ...
    ArchivosTableComponent.prototype.backPage = function () {
        window.history.back();
    };
    ArchivosTableComponent.prototype.addModalShow = function () {
        var _this = this;
        var disposable = this.dialogService.addDialog(__WEBPACK_IMPORTED_MODULE_5__archivos_add_modal_archivos_add_modal_component__["a" /* ArchivosAddModalComponent */])
    ...
    ArchivosTableComponent.prototype.editModalShow = function (archivos) {
        var _this = this;
        var disposable = this.dialogService.addDialog(__WEBPACK_IMPORTED_MODULE_6__archivos_edit_modal_archivos_edit_modal_component__["a" /* ArchivosEditModalComponent */], archivos)
            .subscribe(function (data) {
            if (data) {
                _this.showToast(data);
            }
    ...
    ArchivosTableComponent.prototype.onDeleteConfirm = function (event, item) {
        var _this = this;
    ...
    ArchivosTableComponent.prototype.showToast = function (result) {
        if (result.success) {
    ...
    ArchivosTableComponent.prototype.getAll = function () {
        var _this = this;
        this.service
            .all()
            .subscribe(function (_data) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_router__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__archivos_component__ = __webpack_require__(1290);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_archivos_table_archivos_table_component__ = __webpack_require__(1291);
...
var routes = [
    {
        path: '',
        component: __WEBPACK_IMPORTED_MODULE_1__archivos_component__["a" /* ArchivosComponent */],
        children: [
            { path: 'archivos-table', component: __WEBPACK_IMPORTED_MODULE_2__components_archivos_table_archivos_table_component__["a" /* ArchivosTableComponent */] }
        ]
    }
];
var routing = __WEBPACK_IMPORTED_MODULE_0__angular_router__["a" /* RouterModule */].forChild(routes);
//# sourceMappingURL=archivos.routing.js.map
...
module.exports = "  <archivos-table></archivos-table>\r\n"
