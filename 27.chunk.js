...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__clientes_routing__ = __webpack_require__(1379);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__clientes_component__ = __webpack_require__(1302);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_clientes_table_clientes_service__ = __webpack_require__(81);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_clientes_table_clientes_table_component__ = __webpack_require__(1303);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__clientes_service__ = __webpack_require__(81);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__clientes_add_modal_clientes_add_modal_component__ = __webpack_require__(189);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__clientes_edit_modal_clientes_edit_modal_component__ = __webpack_require__(559);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ordens_components_ordens_table_ordens_add_modal_ordens_add_modal_component__ = __webpack_require__(62);
...
var ClientesTableComponent = (function () {
    function ClientesTableComponent(service, toastrService, dialogService, route, router) {
    ...
    ClientesTableComponent.prototype.insertOrden = function (clientes) {
        ...
        var disposable = this.dialogService.addDialog(__WEBPACK_IMPORTED_MODULE_7__ordens_components_ordens_table_ordens_add_modal_ordens_add_modal_component__["a" /* OrdensAddModalComponent */], orden)
            .subscribe(function (data) {
            if (data) {
    ...
    ClientesTableComponent.prototype.addModalShow = function () {
        var _this = this;
        var disposable = this.dialogService.addDialog(__WEBPACK_IMPORTED_MODULE_5__clientes_add_modal_clientes_add_modal_component__["a" /* ClientesAddModalComponent */])
            .subscribe(function (data) {
            if (data) {
    ...
    ClientesTableComponent.prototype.editModalShow = function (clientes) {
        var _this = this;
        var disposable = this.dialogService.addDialog(__WEBPACK_IMPORTED_MODULE_6__clientes_edit_modal_clientes_edit_modal_component__["a" /* ClientesEditModalComponent */], clientes)
            .subscribe(function (data) {
            if (data) {
                _this.showToast(data);
            }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_router__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__clientes_component__ = __webpack_require__(1302);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_clientes_table_clientes_table_component__ = __webpack_require__(1303);
