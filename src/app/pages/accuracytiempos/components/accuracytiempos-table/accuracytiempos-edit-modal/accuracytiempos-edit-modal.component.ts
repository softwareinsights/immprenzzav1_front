...
@Component({
  ...
  styleUrls: [('./accuracytiempos-edit-modal.component.scss')],
  templateUrl: './accuracytiempos-edit-modal.component.html'
})
export class AccuracytiemposEditModalComponent extends DialogComponent<AccuracytiemposInterface, any> implements OnInit, AccuracytiemposInterface {
  _empleado: string[] = [];
