...
@Component({
  ...
  styleUrls: [('./checkoutestados-add-modal.component.scss')],
  templateUrl: './checkoutestados-add-modal.component.html'
})
export class CheckoutestadosAddModalComponent extends DialogComponent<CheckoutestadosInterface, any> implements OnInit, CheckoutestadosInterface {
