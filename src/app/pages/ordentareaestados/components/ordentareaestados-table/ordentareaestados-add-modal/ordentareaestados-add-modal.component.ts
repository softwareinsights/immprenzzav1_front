...
@Component({
  ...
  styleUrls: [('./ordentareaestados-add-modal.component.scss')],
  templateUrl: './ordentareaestados-add-modal.component.html'
})
export class OrdentareaestadosAddModalComponent extends DialogComponent<OrdentareaestadosInterface, any> implements OnInit, OrdentareaestadosInterface {
  _ordentarea: string[] = [];
  _estadoscrum: string[] = [];
