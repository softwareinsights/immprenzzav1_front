...
@Component({
  ...
  styleUrls: [('./sexos-add-modal.component.scss')],
  templateUrl: './sexos-add-modal.component.html'
})
export class SexosAddModalComponent extends DialogComponent<SexosInterface, any> implements OnInit, SexosInterface {
