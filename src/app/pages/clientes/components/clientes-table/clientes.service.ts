...
export class ClientesService {
    ...
    constructor(
       ...
       findByIdPersona = ( id ) : Observable<ClientesResponseInterface> => {
       ...
       update = ( cliente: ClientesInterface ) : Observable<ClientesResponseInterface> => {
           return this._http.patch(this.endPoint, cliente, this.options)
               .map((response: Response) => response.json())
               .catch(this.handleError);
       }
       ...
       insert = ( cliente: ClientesInterface ) : Observable<ClientesResponseInterface> => {
           return this._http.post(this.endPoint, cliente, this.options)
               .map((response: Response) => response.json())
               .catch(this.handleError);
       }
