...
@Component({
  ...
  styleUrls: [('./ordenestados-edit-modal.component.scss')],
  templateUrl: './ordenestados-edit-modal.component.html'
})
export class OrdenestadosEditModalComponent extends DialogComponent<OrdenestadosInterface, any> implements OnInit, OrdenestadosInterface {
  _orden: string[] = [];
  _estado: string[] = [];
  ...
  onSubmit(values: OrdenestadosInterface): void {
      ...
      if (this.form.valid) {
          this.service
              .update({
                  idordenestado: this.idordenestado,
