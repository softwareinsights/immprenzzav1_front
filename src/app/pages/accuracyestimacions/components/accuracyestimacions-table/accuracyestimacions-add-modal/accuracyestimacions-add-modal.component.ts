...
@Component({
  ...
  styleUrls: [('./accuracyestimacions-add-modal.component.scss')],
  templateUrl: './accuracyestimacions-add-modal.component.html'
})
export class AccuracyestimacionsAddModalComponent extends DialogComponent<AccuracyestimacionsInterface, any> implements OnInit, AccuracyestimacionsInterface {
  _empleado: string[] = [];
  _ordentarea: string[] = [];
