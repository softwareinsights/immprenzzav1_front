...
@Component({
  ...
  styleUrls: [('./productos-add-modal.component.scss')],
  templateUrl: './productos-add-modal.component.html'
})
export class ProductosAddModalComponent extends DialogComponent<ProductosInterface, any> implements OnInit, ProductosInterface {
  _formula: string[] = [];
  _area: string[] = [];
