...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__estadoscrums_routing__ = __webpack_require__(1404);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__estadoscrums_component__ = __webpack_require__(1326);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_estadoscrums_table_estadoscrums_service__ = __webpack_require__(61);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_estadoscrums_table_estadoscrums_table_component__ = __webpack_require__(1325);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__estadoscrums_service__ = __webpack_require__(61);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__estadoscrums_add_modal_estadoscrums_add_modal_component__ = __webpack_require__(92);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__estadoscrums_edit_modal_estadoscrums_edit_modal_component__ = __webpack_require__(566);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__empleadotareaestados_components_empleadotareaestados_table_empleadotareaestados_add_modal_empleadotareaestados_add_modal_component__ = __webpack_require__(539);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ordentareaestados_components_ordentareaestados_table_ordentareaestados_add_modal_ordentareaestados_add_modal_component__ = __webpack_require__(541);
...
var EstadoscrumsTableComponent = (function () {
    function EstadoscrumsTableComponent(service, toastrService, dialogService, route, router) {
    ...
    EstadoscrumsTableComponent.prototype.insertEmpleadotareaestado = function (estadoscrums) {
        ...
        var disposable = this.dialogService.addDialog(__WEBPACK_IMPORTED_MODULE_7__empleadotareaestados_components_empleadotareaestados_table_empleadotareaestados_add_modal_empleadotareaestados_add_modal_component__["a" /* EmpleadotareaestadosAddModalComponent */], empleadotareaestado)
    ...
    EstadoscrumsTableComponent.prototype.insertOrdentareaestado = function (estadoscrums) {
        ...
        var disposable = this.dialogService.addDialog(__WEBPACK_IMPORTED_MODULE_8__ordentareaestados_components_ordentareaestados_table_ordentareaestados_add_modal_ordentareaestados_add_modal_component__["a" /* OrdentareaestadosAddModalComponent */], ordentareaestado)
            .subscribe(function (data) {
            if (data) {
    ...
    EstadoscrumsTableComponent.prototype.addModalShow = function () {
        var _this = this;
        var disposable = this.dialogService.addDialog(__WEBPACK_IMPORTED_MODULE_5__estadoscrums_add_modal_estadoscrums_add_modal_component__["a" /* EstadoscrumsAddModalComponent */])
            .subscribe(function (data) {
            if (data) {
    ...
    EstadoscrumsTableComponent.prototype.editModalShow = function (estadoscrums) {
        var _this = this;
        var disposable = this.dialogService.addDialog(__WEBPACK_IMPORTED_MODULE_6__estadoscrums_edit_modal_estadoscrums_edit_modal_component__["a" /* EstadoscrumsEditModalComponent */], estadoscrums)
            .subscribe(function (data) {
            if (data) {
                _this.showToast(data);
            }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_router__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__estadoscrums_component__ = __webpack_require__(1326);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_estadoscrums_table_estadoscrums_table_component__ = __webpack_require__(1325);
